...
Действительно, в предельном переходе при $t_n \to + \infty$ находим 
$$
\begin{array}{c}
...
В силу условий (\ref{1.15'}), (\ref{1.22'}), (\ref{1.25'}) наложенных на $A(q), P(t, \tau), \Pi_0(t, x)$ и условий теоремы для этого функционала имеем оценку
$$
\begin{array}{c}
