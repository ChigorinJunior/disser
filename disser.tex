...
\usepackage{nccmath}
\usepackage{graphicx}
\graphicspath{{chapter_1/paragraph_1/img/}{chapter_1/paragraph_4/img/}{chapter_2/paragraph_1/img/}{chapter_2/paragraph_2/img/}{chapter_2/paragraph_4/img/}{chapter_3/paragraph_1/img/}{chapter_3/paragraph_3/img/}{appendix/img/}}
...
\begin{document}
	...
	\par \vglue 0.3cm
	\noindent {\bf Глава II. Управление движением двузвенного манипулятора} \dotfill\mbox{\ \ \pageref{p21}}
	...
	\par \vglue 0.3cm
	\noindent  {\bf Глава III. Управление движением трехзвенного манипулятора} \dotfill\mbox{\ \ \pageref{p31}}
	...
	\input{chapter_2/paragraph_4/2_4} 
	\input{chapter_2/paragraph_5/2_5}
	
	\chapter{Управление движением трехзвенного манипулятора}
